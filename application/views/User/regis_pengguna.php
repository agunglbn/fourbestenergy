    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Registration Pengguna</h2>
                    <form class="form-detail" enctype="multipart/form-data"
                        action="<?php echo base_url() ?>regispengguna" method="POST" id="myform">
                        <div class="input-group">
                            <label class="label">NPWP</label>
                            <input class="input--style-4" type="text" name="npwp" placeholder="19312312424 "
