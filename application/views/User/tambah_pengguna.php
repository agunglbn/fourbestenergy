        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form enctype="multipart/form-data" id="" action="<?php echo base_url() ?>User/newpengguna"
                        method="POST">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label for="mobile">NPWP</label>
                                        <input type="text" class="form-control required digits" id="npwp" name="npwp"
                                            maxlength="13" value="<?= set_value('npwp') ?>">
                                    </div>
                                </div>
                                <div class="col-md-7">
                                    <div class="form-group">
